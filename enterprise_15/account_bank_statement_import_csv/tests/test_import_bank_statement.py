...
class TestAccountBankStatementImportCSV(AccountTestInvoicingCommon):
    ...
    def _import_file(self, filename):
        ...
        csv_file_path = get_module_resource('account_bank_statement_import_csv', 'test_csv_file', filename)
    ...
    def test_csv_file_import(self):
        self._import_file('test_csv.csv')
    ...
    def test_csv_file_import_non_ordered(self):
        with self.assertRaises(UserError):
            self._import_file('test_csv_non_sorted.csv')
